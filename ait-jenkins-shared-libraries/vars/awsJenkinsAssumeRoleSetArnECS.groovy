// vars/JenkinsassumeAwsRole.groovy
def call(String environment) {
    def awsRoleMappings = [
        'monitoring': "arn:aws:iam::139543702781:role/euw1-monitoring-iac-jenkins-ecs-role",
        'devops': 'arn:aws:iam::136474465872:role/ait-ec2-devops-EUW-jenkins-glue-role',
        'dev'     : 'arn:aws:iam::981134614696:role/euw1-dev-iac-jenkins-ecs-role',
